/* ==========================================================================
   TECHBISS — Warm Editorial — motion system
   Same technical motion system as App Motion: powers the animated
   device-frame mockup (bar chart grow, SVG line draw, looping toast) plus
   the standard nav/reveal/counter/accordion system. Defensive against
   missing CDN libs / reduced motion.
   ========================================================================== */
(function(){
  "use strict";
