...
<section class="section">
  <div class="container">
    <div class="cta-band spotlight edge-light" data-reveal>
      <div class="cta-band__inner">
        ...
        <div class="cta-band__actions">
          <a class="btn btn--primary btn--lg magnetic icon-shift" href="<?= e(url($primary['path'])) ?>"><?= e($primary['label']) ?><?= icon('arrow-right') ?></a>
          <a class="btn btn--ghost btn--lg magnetic" href="<?= e(url($secondary['path'])) ?>"><?= e($secondary['label']) ?></a>
        </div>
      </div>
    </div>
  </div>
