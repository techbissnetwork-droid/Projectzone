    ...
    <div class="hero__inner">
      ...
      <div class="split split--wide-left" style="align-items:end">
        <div>
          ...
          <h1 class="h1 hero__title" data-reveal="60">The numbers, the constraints and the parts that were hard.</h1>
        </div>
      ...
      <div class="cluster mt-7" data-reveal="160" role="group" aria-label="Filter by industry">
