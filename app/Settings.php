...
final class Settings
{
    ...
    public static function defaults(): array
    {
        ...
        return $d ??= [
            ...
            'hero_eyebrow'     => 'Digital transformation',
            'hero_title_a'     => 'Your Business.',
            'hero_title_b'     => 'Built for the',
            'hero_title_c'     => 'Digital World.',
            'hero_lede'        => 'From offline to online — we build, launch and run everything your business needs to grow.',
            ...
            'services_lede'    => 'Take one module, or let us run the whole stack as a single system.',
            'arch_eyebrow'     => 'Systems, not pages',
            'arch_title'       => "We build digital systems,\nnot just websites.",
            'arch_lede'        => 'Site, app, database, payments, hosting and security — designed as one system, not bolted together.',
            ...
            'pillars_lede'     => 'Certificates, backups, uptime and capacity — the things nobody notices until they fail. We watch them.',
            'mkt_eyebrow'      => 'Ready to launch',
            'mkt_title'        => "Premade projects,\nyours today.",
            'mkt_lede'         => 'Systems already built and tested. Buy it, we install and brand it for you.',
