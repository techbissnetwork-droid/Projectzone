/* ==========================================================================
   TECHBISS — Fintech Signal — motion system
   Header scroll state, mega-menu + mobile nav, magnetic CTA, IntersectionObserver
   scroll reveals with stagger, animated stat counters, accordion, filmstrip
   drag-scroll, and a light GSAP hero-title fade-in. No device-frame mockup in
   this concept, so there's nothing to "activate" — reveals just fade content in.
