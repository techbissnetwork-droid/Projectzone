/* ==========================================================================
   TECHBISS — Numbers First — motion system
   Same core engine as every concept: nav/mega-menu, mobile-nav, scroll
   reveals, the [data-count] counter (here driving the giant hero numeral
   as well as every small stat on the page), accordion and filmstrip
   drag-scroll. Defensive against missing CDN libs / reduced motion.
   ========================================================================== */
(function(){
  "use strict";
  ...
  /* ---------------- Scroll reveals (also activates device-frame charts) ---------------- */
