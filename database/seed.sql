...
('business-website','Website Setup','Domain, hosting, the site itself and business email — set up and launched as one job.','Everything to run your business online: domain, hosting, DNS and SSL, a custom-built website, professional email on your own domain, and an online store if you sell products. Set up and launched together, not sold piece by piece.','<p>Your domain is the one asset that stays with you, so we register it in your name, point DNS correctly, and provision managed hosting with SSL installed and renewed automatically. The website itself is built around what your business does and what a visitor needs to decide — responsive from the first breakpoint, with a CMS so you can edit it yourself.</p><p>Professional email on your own domain is included, configured so it actually reaches the inbox. If you sell products, we build the store into the same site — catalogue, checkout, payments and the order tooling behind them. One job, one team, one thing to maintain.</p>','window','violet','Domain registered in your name, DNS configured\nManaged hosting with SSL installed and auto-renewed\nCustom-designed, responsive website with an editable CMS\nProfessional email on your domain (SPF, DKIM, DMARC configured)\nOnline store with catalogue, checkout and payments, if you sell products\nContact and enquiry forms\nDaily backups and uptime monitoring\nAnalytics and Search Console setup',1,1,1,'Website, Domain, Hosting & Email Setup','Domain registration, managed hosting with SSL, a custom website and business email — set up and launched as one job.',NOW(),NOW()),
