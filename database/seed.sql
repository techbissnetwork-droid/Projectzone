...
('web-applications','Web Applications','Custom systems built around business workflows.','Booking systems, portals, dashboards and internal tools that fit the way your team already works.','<p>When a spreadsheet stops scaling, a web application takes over. We map the workflow you run today, then build the smallest system that removes the manual steps — with the reporting you need to see what is happening.</p>','layers','blue','Workflow mapping\nDatabase design\nRole-based access\nAdmin dashboards\nReporting and exports\nThird-party integrations',1,1,3,'Custom Web Application Development','Booking systems, portals and internal tools designed around your existing business workflows.',NOW(),NOW()),
('mobile-applications','Mobile Applications','Professional Android and iOS applications.','Native-quality mobile apps for customers or for the team in the field.','<p>We build mobile apps when a phone is genuinely the right place for the job — field data capture, loyalty, ordering, bookings. Shipped to both stores, with the release and update process handled.</p>','device','emerald','Android and iOS builds\nApp store submission\nPush notifications\nOffline-capable data\nAnalytics\nRelease management',0,1,4,'Android & iOS App Development','Professional mobile applications for customers and field teams, built and shipped to both stores.',NOW(),NOW()),
