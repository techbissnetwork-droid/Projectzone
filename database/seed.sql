...
SELECT s.id, f.title, f.descr, f.ord FROM `services` s JOIN (
  ...
  UNION ALL SELECT 'mobile-apps','Ships to both app stores','Android and iOS, submitted and managed through release.',1
  UNION ALL SELECT 'mobile-apps','Works without signal','Offline-capable data and push notifications.',2
...
-- business email and e-commerce now live inside 'business-website'.
-- 'web-applications' and 'mobile-apps' are separate services; industries
-- below are linked to whichever one is the more likely first need.
