...
.admin-login-wrap{ max-width:400px; width:100%; }
</style>
</head>
<body>
<main class="admin-login-wrap">
  ...
  <div class="card" style="background:var(--grad);color:#fff2ea;border:none;text-align:center;padding:36px;margin-top:20px;">
    <div style="width:56px;height:56px;margin:0 auto 16px;"><?= logo_mark_html(false, '../') ?></div>
    <h3 style="color:#fff2ea;">Welcome back.</h3>
    <p style="color:rgba(255,242,234,.9);margin-bottom:0;">Businesses, tickets, orders and every setting are exactly where you left them — sign in to pick up right where you left off.</p>
  </div>
</main>
</body>
</html>
