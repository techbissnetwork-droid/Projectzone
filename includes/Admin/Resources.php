        ...
        return [
            ...
            'client_projects' => [
                ...
                'fields' => [
                    ...
                    ['key' => 'launched_on', 'label' => 'Launched', 'type' => 'date'],
                    ['key' => 'domain_renews_on', 'label' => 'Domain renews', 'type' => 'date', 'hint' => 'Watched by the dashboard, same as the three below — you get a heads-up 30 days out.'],
                    ['key' => 'hosting_renews_on', 'label' => 'Hosting renews', 'type' => 'date'],
                    ['key' => 'ssl_expires_on', 'label' => 'SSL certificate expires', 'type' => 'date'],
