...
<section class="hero" id="hero" data-theme="deep">
  ...
  <div class="hero__viz" id="viz" aria-hidden="true">
    ...
    <div class="viz__nodes" id="vizNodes">
      ...
      <?php foreach (['Business','Domain','Website','App','Hosting','Email','Security','Payments','Growth'] as $n): ?>
        <div class="vnode" data-node="<?= e(strtolower($n)) ?>" data-ring="1"><span class="vnode__label"><?= e($n) ?></span></div>
      <?php endforeach; ?>
    </div>
    <div class="viz__hud">
  ...
  <div class="shell hero__inner">
    ...
    <h1 class="hero__title">
      <span class="mask" data-d="1"><span><?= e(Settings::get('hero_title_a')) ?></span></span>
      <span class="mask" data-d="2"><span><?= e(Settings::get('hero_title_b')) ?></span></span>
    ...
    <dl class="hero__stats reveal" data-d="6">
      <div><dt>Services under one roof</dt><dd data-count="<?= count($services) ?: 9 ?>"><?= count($services) ?: 9 ?></dd></div>
      <div><dt>Delivery model</dt><dd class="is-text">End&#8209;to&#8209;end</dd></div>
      <div><dt>Infrastructure uptime</dt><dd class="is-text">99.98%</dd></div>
    </dl>
  </div>

  <a class="hero__scroll" href="#shift" aria-label="Scroll to next section">
    <span class="hero__scrollLine" aria-hidden="true"></span><span>Scroll</span></a>
</section>

<?php require __DIR__ . '/partials/section_shift.php'; ?>

<!-- 03 · SERVICES -->
<section class="svcs" id="services">
  <div class="shell">
    <header class="sec__head">
      <p class="eyebrow reveal"><span class="num">03</span> The ecosystem</p>
      <h2 class="sec__title reveal">Everything your business<br>needs to exist online.</h2>
      <p class="sec__lede reveal">Commission one module, or let <?= e(Settings::get('site_name')) ?> run the entire stack — domain to analytics — as a single system.</p>
    </header>
    <div class="svcs__grid" id="svcGrid">
      <?php require __DIR__ . '/partials/service_cards.php'; ?>
    </div>
    <p class="svcs__foot reveal">
      <a class="link" href="<?= e(url('services.php')) ?>">See every service in detail <span aria-hidden="true">→</span></a>
    </p>
  </div>
</section>

<?php require __DIR__ . '/partials/section_arch.php'; ?>
<?php require __DIR__ . '/partials/section_process.php'; ?>
...
<section class="work" id="work" data-theme="deep">
  <div class="shell">
    <header class="sec__head sec__head--split">
      <div>
        <p class="eyebrow reveal"><span class="num">06</span> Selected builds</p>
        <h2 class="sec__title reveal">Businesses that moved<br>their operations online.</h2>
      </div>
      <p class="sec__lede reveal">Delivered projects, with the scope and the outcome.
        ...
        <article class="wcard reveal<?= $i === 0 ? ' wcard--lead' : '' ?>">
          <a class="wcard__link" href="<?= e(url('portfolio-item.php?slug=' . urlencode($w['slug']))) ?>">
            <div class="wcard__media tilt">
              ...
              <?php else: ?>
                <div class="wcard__ph" aria-hidden="true"><span class="sk sk--h"></span><span class="sk sk--t"></span><div class="browser__cards"><i></i><i></i><i></i></div></div>
              <?php endif; ?>
            </div>
...
<section class="mkt-strip">
  <div class="shell">
    <header class="sec__head sec__head--split">
      <div>
        <p class="eyebrow reveal"><span class="num">07</span> Ready to launch</p>
        <h2 class="sec__title reveal">Premade projects,<br>yours today.</h2>
      </div>
      <p class="sec__lede reveal">Complete systems we have already built and tested. Buy the source, we install and brand it for you.
...
<section class="trust" data-theme="deep">
  <div class="shell">
    <p class="trust__quote reveal">“<?= e(Settings::get('quote')) ?>”</p>
  </div>
</section>
