    ...
    <>
      ...
      <Section aria-label="What's included" className="border-y border-white/5 bg-white/[0.015]">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
          <Reveal>
            <SectionHeading eyebrow="What's included" title="Security that meets what your customers expect" />
          </Reveal>
          <Reveal delay={0.1}>
      ...
      <Section aria-label="How it works" className="border-y border-white/5 bg-white/[0.015]">
        <Reveal>
          <SectionHeading eyebrow="How it works" title="Hardened by default, monitored continuously" />
        </Reveal>
        <div className="mt-10">
          <MiniProcess
            steps={[
              { title: "Security assessment", description: "We review your current setup for gaps in certificates, headers, and access control." },
              { title: "Certificate & header configuration", description: "SSL/TLS certificates issued and security headers configured and hardened." },
              { title: "Monitoring setup", description: "Malware and vulnerability monitoring configured with alerting in place." },
              { title: "Response playbook", description: "A clear incident response playbook handed over to your team." },
            ]}
          />
        </div>
      </Section>
      ...
      <CtaSection
        title="Don't let security be an afterthought."
        description="Get SSL, hardening, and monitoring configured correctly from the start."
      />
    </>
  );
}
